...
export const ja: TranslationKeys = {
  ...
  "auth.key_mismatch": "このユーザIDは異なる鍵で登録済みです。別のユーザIDを使用してください。",
  ...
  "error.group_create_failed": "グループの作成に失敗しました。",
  ...
  "error.icon_too_large": "画像が大きすぎます。5 MB以下の画像を選択してください。",
  "error.archive_failed": "アーカイブに失敗しました。",
  "chat.archive": "アーカイブ",
  "chat.unarchive": "アーカイブ解除",
  "chat.show_archived": "アーカイブ済みを表示",
  "chat.no_archived_groups": "アーカイブ済みグループはありません",
